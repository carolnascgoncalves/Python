...
else: #Se o input valor não for um número: muda o erro_venda pra True (verdadeiro)
    erro_venda = True
...
else: #Se o input cupom não for 's' ou 'n', a resposta é invalida então o erro_cupom vira True
    erro_cupom = True 


if(erro_venda == False and erro_cupom == False): #Se todos os erros sao False, ele mostra o print certo
